 ...
 CREATE TABLE dbo.STG_SPW_ACCOUNT_DETAIL
(
    ID                  BIGINT          NOT NULL,
    ...
    CONSTRAINT PK_STG_SPW_ACCOUNT_DETAIL 
        PRIMARY KEY (ID)
);

CREATE TABLE dbo.STG_SPW_POSITION_DETAIL
(
    ID                  BIGINT          NOT NULL,
    PACKAGE_ID          BIGINT          NOT NULL,
    account_number      VARCHAR(20)     NULL,
    ...
    CONSTRAINT PK_STG_SPW_POSITION_DETAIL 
        PRIMARY KEY (ID)
);